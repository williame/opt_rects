...
function glInit() {
	...
	window.anisotropic = gl.getExtension("EXT_texture_filter_anisotropic") ||
		gl.getExtension("MOZ_EXT_texture_filter_anisotropic") || 
		gl.getExtension("WEBKIT_EXT_texture_filter_anisotropic");
	window.max_anisotropy = anisotropic? gl.getParameter(anisotropic.MAX_TEXTURE_MAX_ANISOTROPY_EXT): 0;
	window.anisotropy = max_anisotropy;
}
